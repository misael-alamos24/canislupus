    ...
    return (
        <div className='nav'>
          <div className='container'>
            ...
            <div className={actualSection==='Contacto'?"green pointer": 'pointer'} onClick={()=> navigate("/contacto")}>Contacto</div>
            <div className={actualSection==='Ayuda'?"green pointer": 'pointer'} onClick={()=> navigate("/ayuda")}>Ayuda</div>
          </div>
        </div>
    )
};